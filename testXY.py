...
from XYground import XYDataset, XYDatasetLoader
from XYmfa import XYmfaDataset, XYmfaDatasetLoader
from Ising_g import IsingDataset,IsingDatasetLoader
from Ising_mfa import IsingMfaDataset,IsingMfaDatasetLoader
...
x = XYDatasetLoader()
y = XYmfaDatasetLoader()
x2 = IsingDatasetLoader()
y2 = IsingMfaDatasetLoader()
...
IsingG_dataset, IsingG_dataloader = x2.return_dataset()
IsingMfa_dataset, IsingMfa_dataloader = y2.return_dataset()
...
#     print("Iterating through Ising (for accuracy)...")    
#     for J, eigenvalue, eigenvector, val in tqdm(IsingG_dataloader):
#         pred = model(eigenvector)
#         predictions_g.append(pred.item())
#         print("state:", eigenvector)
#         print("val:", val)
...
#     print("Iterating through XY_MFA (for accuracy)...")
#     for J, eigenvalue, _, val, eigenvector in tqdm(IsingMfa_dataloader):
#         pred = model(eigenvector)
#         predictions_mfa.append(pred.item())
